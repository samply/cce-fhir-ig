# Vital Status - CCE FHIR Implementation Guide v0.6.3

## Resource Profile: Vital Status 

 
Determination of the patient's vital status 

**Usages:**

* This Profile is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cce.fhir|current/StructureDefinition/StructureDefinition-VitalStatus.json)
