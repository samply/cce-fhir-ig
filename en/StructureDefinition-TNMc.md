# TNMc - CCE FHIR Implementation Guide v0.6.1

## Resource Profile: TNMc 

 
Staging of tumor diseases according to the TNM classification (clinical) in accordance with the current AJCC edition 

**Usages:**

* Refer to this Profile: [Primary Diagnosis](StructureDefinition-PrimaryDiagnosis.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cce.fhir|current/StructureDefinition/StructureDefinition-TNMc.json)
...
Other representations of profile: [CSV](../StructureDefinition-TNMc.csv), [Excel](../StructureDefinition-TNMc.xlsx), [Schematron](../StructureDefinition-TNMc.sch) 
